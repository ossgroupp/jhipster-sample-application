package com.libertytree.commercechassis.web.rest;

import static org.springframework.web.servlet.mvc.method.annotation.SseEmitter.event;

import com.libertytree.commercechassis.config.KafkaSseConsumer;
import com.libertytree.commercechassis.config.KafkaSseProducer;
...
public class JhipsterSampleApplicationKafkaResource {
    ...
    public JhipsterSampleApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
