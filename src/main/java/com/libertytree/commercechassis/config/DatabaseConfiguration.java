package com.libertytree.commercechassis.config;
...
@Configuration
@EnableMongock
@EnableElasticsearchRepositories("com.libertytree.commercechassis.repository.search")
@EnableMongoRepositories(
    basePackages = "com.libertytree.commercechassis.repository",
